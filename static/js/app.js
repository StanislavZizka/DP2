...
class App {
    ...
    initializeNavigation() {
        // Navigation is handled by existing navigation.js
    ...
    initializeImageViewer() {
        // Image viewer is handled by existing image-viewer.js
        // Just ensure it's loaded
    ...
    bindGlobalEvents() {
        ...
        document.addEventListener('languageChanged', (event) => {
            ...
            // Update any components that need language updates
        ...
        document.addEventListener('textureGenerated', (event) => {
            ...
            // Handle any global actions after texture generation
        });

        // Handle page visibility changes
        document.addEventListener('visibilitychange', () => {
            if (document.hidden) {
                // Page is hidden - pause any animations or long-running processes
...
document.addEventListener('DOMContentLoaded', () => {
    window.app = new App();
    console.log('Mathematical Texture Generator App initialized');
});
